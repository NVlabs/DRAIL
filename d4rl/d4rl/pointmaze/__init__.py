...
from .maze_toy_train import MazeToyTrain, OPEN
from .maze_toy_test import MazeToyTest, OPEN
...
register(
    id='maze2d-toy-train-v0',
    entry_point='d4rl.pointmaze:MazeToyTrain',
...
register(
    id='maze2d-toy-test-v0',
    entry_point='d4rl.pointmaze:MazeToyTest',
    max_episode_steps=200,
    kwargs={
        'maze_spec':OPEN,
        'reward_type':'sparse',
