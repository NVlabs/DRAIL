...
num2 = 800
num3 = 1300
points1 = generate_solid_rectangle_points(0.1, 0.3, 0.1, 0.3, num1)
points2 = generate_solid_rectangle_points(0.5, 0.7, 0.5, 0.6, num2)
points3 = generate_solid_rectangle_points(0.3, 0.5, 0.3, 0.5, num3)
